...
public class DownloadService extends Service {
    ...
    private Handler mHandler = new Handler(){
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_INIT:
                    length= Integer.parseInt(String.valueOf(msg.obj));
//                    length =(String)msg.obj;
                ...
                case DOWNLOAD_SUCCESS:
                    ...
                    break;
                case URL_ERROR:
                    Toast.makeText(DownloadService.this, "下载地址错误"+url, Toast.LENGTH_SHORT).show();
                    break;
                case NET_ERROR:
    ...
    private void notifyNotification(long percent,long length){
        ...
        notificationManager.notify(R.layout.notification_item, notification);
        if((percent/length)>=1){
            contentView.setTextViewText(R.id.text_tv,"下载完成");
